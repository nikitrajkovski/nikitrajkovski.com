  ...
  return (
    <Box maxW="7xl" pt={{base: "0", md: "20"}}>
      ...
      <Flex justify="center" align="center" mt={6} mx={4}>
        <Text color="#02020B" fontSize={{base: "md", md: "lg"}} textAlign="center">
          ...
          <Flex maxW="7xl" py={8} direction="column" gap={16}>
            <Flex direction="column" gap={4}>
              <Flex direction="row" justify="left" align={{base: "left", md: "center"}} gap={4}>
                <Icon size={{base: "xl", md: "2xl"}} color="black"><FaHammer/></Icon>
                <Text fontSize={{base: "xl", md: "2xl"}} color="#D36135">Software
                  Development
                </Text>
              </Flex>
              <Text color="black" textAlign={{base: "right", md: "left"}}>From eye-catching
            ...
            <Flex direction="column" gap={4}>
              <Flex direction="row" justify="left" align={{base: "left", md: "center"}} gap={4}>
                <Icon size={{base: "xl", md: "2xl"}} color="black"><FaRocket/></Icon>
                <Text fontSize={{base: "xl", md: "2xl"}} color="#D36135">System Optimization</Text>
              </Flex>
              <Text color="black" textAlign={{base: "right", md: "left"}}>Revitalize your existing
          ...
          <Flex maxW="7xl" py={8} direction="column" gap={16}>
            <Flex direction="column" gap={4}>
              <Flex direction="row" justify="left" align={{base: "center", md: "center"}} gap={4}>
                <Icon size={{base: "xl", md: "2xl"}} color="black"><GrUserWorker/></Icon>
                <Text fontSize={{base: "xl", md: "2xl"}} color="#D36135">Full-Cycle Problem
                  Solving
                </Text>
              </Flex>
              <Text color="black" textAlign={{base: "right", md: "left"}}>I don’t just write code. I
            ...
            <Flex direction="column" gap={4}>
              <Flex direction="row" justify="left" align={{base: "left", md: "center"}} gap={4}>
                <Icon size={{base: "xl", md: "2xl"}} color="black"><FaPaintBrush/></Icon>
                <Text fontSize={{base: "xl", md: "2xl"}} color="#D36135">User Interface</Text>
              </Flex>
              <Text color="black" textAlign={{base: "right", md: "left"}}>I craft intuitive,
